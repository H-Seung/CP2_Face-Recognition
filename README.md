...
프로젝트 개요
-------------
- 프로젝트 배경 : 회원가입 후 본인인증을 자동화하기 위해 앱 사용자가 등록한 사진과 갤러리 내 사진을 비교해 동일인인지 판별하는 모델을 구축한다.
- 이용 데이터 : AI hub 한국인 안면 데이터 약 170만장, 기업제공 데이터 약 1천장

프로젝트 구성
-------------
![image](https://github.com/H-Seung/CP2_Face-Recognition/assets/114974542/8dcd0411-d274-4bb8-9159-e98327b29056)
